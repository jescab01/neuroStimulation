...
def phasediff_parallel(params):
    ...
    for ii, set in enumerate(params):
        ...
        for ii, roi in enumerate(conn.region_labels):
            ...
            datapoints.append((mode + "_sigma"+str(sigma), "baseline", r, roi, w, f, fpeak[ii], amp_fex05[ii], amp_fpeak05[ii], plv[ii, :], efPhase[ii]))
        ...
        for ii, roi in enumerate(conn.region_labels):
            ...
            datapoints.append((mode + "_sigma"+str(sigma), "stimulation", r, roi, w, f, fpeak[ii], amp_fex05[ii], amp_fpeak05[ii], plv[ii, :], efPhase[ii]))
